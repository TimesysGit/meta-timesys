...
## [v2.4.1+krogoth] - 2021-01-06

### Fixed

* [tsmeta] Make sure we don't rename libubootenv

## [v2.4.0+krogoth] - 2020-12-09)
...
## [v2.3.0+krogoth] - 2020-09-24

### Changed

* [kernel] Use better checking for backfilling kernel dependencies (legacy)

## [v2.2.0+krogoth] - 2020-08-31
...
* [krogoth] Fixups for python 2.7
* [checkcves] Python fixups for krogoth

## [v2.0.1+krogoth] - 2019-08-13

### Fixed

* [tsmeta] 3 bug fixes

## [v2.0.0+krogoth] - 2019-08-13
...
## [v1.13.0+krogoth] - 2018-07-12

### Added

* checkcves: Print summary of results

## [v1.12.0+krogoth] - 2018-06-25
...
* manifest: sort images list

### Removed

* Remove unused demos and mirroring config

## [v1.11.0+krogoth] - 2018-03-28
...
## [v1.8.0+krogoth] - 2017-12-05

### Added

* cvecheck: Support web-only results without a subscription

## [v1.7.0+krogoth] - 2017-11-15

### Fixed

* Quiet stderr on git operations 
* Update some backported changes for krogoth

## [v1.6.0+krogoth] - 2017-11-10

### Changed

* update cve fields, add date

## [v1.5.0+krogoth] - 2017-11-06
...
## [v1.2.0+krogoth] - 2017-07-28

### Changed

* checkcves: Update for new results format

## [v1.1.0+krogoth] - 2017-07-25
